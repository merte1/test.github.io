	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			fb_strong_Att1WithCatA_Att2WithCatB : '<p> categoryB ile attribute2 ve categoryA ile attribute1 ilişkilendiren <strong>güçlü düzeyde</strong> bilinçsiz önyargıya sahipsiniz. </p>',
			fb_moderate_Att1WithCatA_Att2WithCatB : '<p> categoryB ile attribute2 ve categoryA ile attribute1 ilişkilendiren <strong>orta düzeyde</strong> bilinçsiz önyargıya sahipsiniz.</p>',
			fb_slight_Att1WithCatA_Att2WithCatB : '<p> categoryB ile attribute2 ve categoryA ile attribute1 ilişkilendiren <strong>az düzeyde</strong> bilinçsiz önyargıya sahipsiniz.</p>',
			fb_equal_CatAvsCatB : '<p> categoryA ile attribute1 ve categoryB ile attribute2 ilişkilendiren bilnçsiz önyargıya sahip değilsiniz. </p>',
