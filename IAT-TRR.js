	...
	**/
	...
	function iatExtension(options) {
		...
		*/
		...
		var messageDef = [
			{ cut: '-0.65', message: piCurrent.results.strong_Att1WithCatA_Att2WithCatB },
			{ cut: '-0.35', message: piCurrent.results.moderate_Att1WithCatA_Att2WithCatB },
			{ cut: '-0.15', message: piCurrent.results.slight_Att1WithCatA_Att2WithCatB },
			{ cut: '0.15', message: piCurrent.results.equal },
			{ cut: '0.35', message: piCurrent.results.slight_Att1WithCatB_Att2WithCatA },
			{ cut: '0.65', message: piCurrent.results.moderate_Att1WithCatB_Att2WithCatA },
			{ cut: '5', message: piCurrent.results.strong_Att1WithCatB_Att2WithCatA }
		];
		debugger;
