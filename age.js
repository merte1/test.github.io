...
define(['pipAPI', window.koc.sourceBase + '/IAT-TRR.js' + '?r=' + uniqueId()], function (APIConstructor, iatExtension) {
	...
	return iatExtension({
		...
		results: {
			...
			equal: `Cevaplamış olduğun bu teste göre Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren sahip değilsin. Harvard Örtük Çağrışım Testi’ni tamamlayanların % 15'inin Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren az düzeyde bilinçsiz ön yargıya sahip olduğu görüldü.`,
			strong_Att1WithCatB_Att2WithCatA:  `Cevaplamış olduğun bu teste göre Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren sahip değilsin. Harvard Örtük Çağrışım Testi’ni tamamlayanların % 15'inin Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren az düzeyde bilinçsiz ön yargıya sahip olduğu görüldü.`,
			moderate_Att1WithCatB_Att2WithCatA:  `Cevaplamış olduğun bu teste göre Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren sahip değilsin. Harvard Örtük Çağrışım Testi’ni tamamlayanların % 15'inin Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren az düzeyde bilinçsiz ön yargıya sahip olduğu görüldü.`,
			slight_Att1WithCatB_Att2WithCatA:  `Cevaplamış olduğun bu teste göre Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren sahip değilsin. Harvard Örtük Çağrışım Testi’ni tamamlayanların % 15'inin Yaşlı Kişiler ile olumsuzu ve Genç Kişiler ile olumluyu ilişkilendiren az düzeyde bilinçsiz ön yargıya sahip olduğu görüldü.`
		}
	});
});
